...
/*
 * N.B.: This file is quite similar to the one available on
 *                  https://github.com/rboman/dgwaves
 *
 * Goal of the script: for each 2D element, create 1D elements over the edges,
 * and store the associated adjacent elements
 *
 */
