...
srun ./build/bin/main ./Geometry/2D\ Rectangle/rectangle0_5_quad.geo ./Geometry/2D\ Rectangle/newMesh.msh  ./Params/param.dat ./Geometry/2D\ Rectangle/newResults.msh
